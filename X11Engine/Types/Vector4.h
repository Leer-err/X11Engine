...
struct vector4 {
    ...
    inline vector4(const DirectX::XMVECTOR& vec) {
    ...
    inline vector4 negate() const { return DirectX::XMVectorNegate(*this); }

    inline vector4 __vectorcall operator+(const vector4& other) const {
    ...
    inline vector4& __vectorcall operator+=(const vector4& other) {
        *this = DirectX::XMVectorAdd(*this, other);
    }
    inline vector4& __vectorcall operator-=(const vector4& other) {
        *this = DirectX::XMVectorSubtract(*this, other);
    }

    inline vector4 __vectorcall operator*(const float& value) const {
    ...
    inline vector4& __vectorcall operator*=(const float& value) {
        *this =
    ...
    inline bool __vectorcall operator==(const vector4& other) const {
    ...
    vector4 __vectorcall operator*(const DirectX::XMMATRIX& m) const {
        return DirectX::XMVector4Transform(*this, m);
    }
...
inline float __vectorcall dot(const vector4& a, const vector4& b) {
